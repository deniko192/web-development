...
<body>
    <form class="form" method="post" action="">
        <img src="/task1/src/img/welcome.png" alt="welcome"/>
        <div class="form__title">Записаться на курс</div>
        <input class="form__input" type="text" placeholder="Ваше имя" name="userName" maxlength="30"/>
        ...
        <select class="form__input form__select" name="activity" required>
            <option class="form__option" selected hidden>Деятельность</option>
